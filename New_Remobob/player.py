        ...
        while True:
            try:
                ...
                while True: #Se le pedirá que coloque la contraseña de 3 digitos
                    ...
                    if len(self.pasw) != 3: #nos aseguramos de que la contraseña sea de 3 digitos
                ...
                self.pasw = tuple(pasw_r,pasw_c,pasw)
                ...
                self.cable = tuple(cable_r,cable_c,cable,color)
                input(f''' 
            ...
            Cable = columna:{self.cable[1]}  fila:{self.pasw[0]}  color:{self.pasw[3]}
